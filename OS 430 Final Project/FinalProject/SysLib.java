...
public class SysLib {
    ...
    // modifed/added code
     ...
     public static int open(String fileName, String mode) {
         String[] fileInfomation = new String[2];
         fileInfomation[0] = fileName;
         fileInfomation[1] = mode;
         return Kernel.interrupt(Kernel.INTERRUPT_SOFTWARE, Kernel.OPEN, 0, fileInfomation);
     }
     ...
     public static int seek(int fileDescriptor, int offset, int input) {
         int[] arr = new int[2];
         arr[0] = offset;
         arr[1] = input;
         return Kernel.interrupt(Kernel.INTERRUPT_SOFTWARE, Kernel.SEEK, fileDescriptor, arr);
     }
